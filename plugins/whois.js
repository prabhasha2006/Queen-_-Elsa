...
if (CON.LANG == 'SI') ADMİN_USER = '*පරිපාලකයන් ගනන:*', USER_USER = '*සාමාජ්කයන් ගනන:*', TR_USER = '*තුර්කි සාමාජිකයින් ගනන:*', Hİ_USER = '*ඉන්දියානු සාමාජිකයන් ගනන:*', AZ_USER = '*Azerbayjan Member Count:*', SRİ_USER = '*ශ්‍රී ලංකා සාමාජිකයන් ගනන:*', RU_USER = '*රුසියානු සාමාජිකයන් ගනන:*', USA_USER = '*USA සාමාජිකයන් ගනන:*', OTHER = '*වෙනත් සාමාජිකයන් ගනන:*'
...
if (CON.WORKTYPE == 'private') {
    lusifar.addCommand({ pattern: 'whois$', fromMe: true, desc: Lang.PL_DESC }, async (message, match) => { 
    ...
    lusifar.addCommand({ pattern: 'whois$', fromMe: false, desc: Lang.PL_DESC }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var json = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
