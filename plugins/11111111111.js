...
lusifar.addCommand({pattern: 'nrainbow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/3d-rainbow-color-calligraphy-text-effect-1049.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/LUSIFARWABOT/crainbow.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/LUSIFARWABOT/crainbow.jpg'), MessageType.image, { caption: Config.AFN })
              })
          } catch(err) { 
              console.log(err)
          } 
