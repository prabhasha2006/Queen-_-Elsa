...
let msg = Config.LANG == 'TR' || Config.LANG == 'AZ' ? '*Bu Plugin Resmi Olarak Onaylanmıştır!* ✅' : '*This Plugin is Officially Approved by ✮𝐐𝐔𝐄𝐄𝐍--𝐄𝐋𝐒𝐀✮!* ✅'
let unmsg = Config.LANG == 'TR' || Config.LANG == 'AZ' ? '*Bu Plugin Resmi Değildir!* ❌' : '*✮𝐐𝐔𝐄𝐄𝐍--𝐄𝐋𝐒𝐀✮ not accptt this Plugin please remove this!* ❌'
...
lusifar.addCommand({pattern: 'pkg ?(.*)', fromMe: true, desc: Lang.INSTALL_DESC, warn: Lang.WARN, dontAddCommandList: true}, (async (message, match) => {
    ...
    if (response.statusCode == 200) {
        ...
        try {
            ...
            fs.unlinkSync('/root/LUSIFARWABOT/plugins/' + plugin_name + '.js')
