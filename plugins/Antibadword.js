...
if (Config.LANG == 'SI') ldc = '*නරක වචන මෙහි භාවිතා කිරීම ✮𝐐𝐔𝐄𝐄𝐍--𝐄𝐋𝐒𝐀✮ විසින් තහනම් කර ඇත \n පිලියම :- ඉවත් කිරීම*'
...
lusifar.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (antibad_var == 'true' && message.jid !== '905511384572-1616356915@g.us') {
        ...
        let regex62 = new RegExp('බේසික්')
        let regex63 = new RegExp('බඩුව')
        let regex64 = new RegExp('බේසික')
        let regex65 = new RegExp('වේසි')
        let regex66 = new RegExp('පයිය')
        let regex67 = new RegExp('පයියා')
        let regex68 = new RegExp('b ')
        let regex69 = new RegExp('besic ')
